...
\begin{align*}
&\dfrac{\mathrm{GTD}_1}{\mathrm{GTD}_2} = 1-\num{4.99996e-1} \quad \text{(via $r_s$)}\\
...
\noindent\textbf{Time-dilation ratio between System 1 and System 2, computed two ways:}\par\nobreak
\begin{align*}
&\dfrac{\mathrm{GTD}_1}{\mathrm{GTD}_2} = 1-\num{9.9683773e-1} \quad \text{(via $r_s$)}\\
...
\noindent\textbf{Time-dilation ratio between System 1 and System 2, computed two ways:}\par\nobreak
\begin{align*}
&\dfrac{\mathrm{GTD}_1}{\mathrm{GTD}_2} = 1-\num{9.007763e-1} \quad \text{(via $r_s$)}\\
...
\noindent\textbf{Time-dilation ratio between System 1 and System 2, computed two ways:}\par\nobreak
\begin{align*}
&\dfrac{\mathrm{GTD}_1}{\mathrm{GTD}_2} = 1-\num{7.42618e-6} \quad \text{(via $r_s$)}\\
...
\noindent\textbf{Time-dilation ratio between System 1 and System 2, computed two ways:}\par\nobreak
\begin{align*}
&\dfrac{\mathrm{GTD}_1}{\mathrm{GTD}_2} = 1-\num{4.92632e-1} \quad \text{(via $r_s$)}\\
