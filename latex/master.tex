...
\medskip\noindent\textbf{Calculate DTD for each System:}
  ...
  \quad K_1 &= \dfrac{\num{2.00000e30}\,\text{kg}}{(\num{3.00000e3}\,\text{m})(\num{6.73295e26}\,\text{kg/m})}\\
  &= \num{9.9015538e-1}\\
  \mathrm{DTD}_1 &= \sqrt{\num{9.9015538e-1}} = \num{9.9506552e-1}\\[2pt]
  \quad K_2 &= \dfrac{\num{2.00000e30}\,\text{kg}}{(\num{7.00000e8}\,\text{m})(\num{6.73295e26}\,\text{kg/m})}\\
  &= \num{4.24352e-6}\\
...
\[
\begin{aligned}
\mathrm{GTD}_{r1} &= \sqrt{1-K_{r1}} = \sqrt{1-\num{9.9015333e-1}} = \sqrt{\num{9.84667e-3}}\\
  &= \num{9.92303e-2} = 1-\num{9.007697e-1}\\
\mathrm{GTD}_{r2} &= \sqrt{1-K_{r2}} = \sqrt{1-\num{4.24352e-6}} = \sqrt{\num{9.999957565e-1}}\\
  &= \num{9.999978782e-1} = 1 - \num{2.12180e-6}
\end{aligned}
\]
\[
\begin{aligned}
\dfrac{\mathrm{GTD}_{r1}}{\mathrm{GTD}_{r2}} &= \dfrac{\num{9.92303e-2}}{\num{9.999978782e-1}}\\
  &= \num{9.92305e-2}
\end{aligned}
\]
...
\]
\[
\dfrac{\mathrm{GTD}_{r1}}{\mathrm{GTD}_{r2}} = \num{9.92305e-2}
\]
\[
\begin{aligned}
...
How does $\mathrm{GTD}_{r1}/\mathrm{GTD}_{r2}$ compare to $\mathrm{GTD}_{d1}/\mathrm{GTD}_{d2}$? They are the same, confirming that the same compactness ratio $K$ is returned by both the Schwarzschild radius and the DeGerlia compactness ratio, and that both yield the same GTD result.
