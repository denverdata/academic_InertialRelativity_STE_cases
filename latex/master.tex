...
\[
\dfrac{\mathrm{GTD}_1}{\mathrm{GTD}_2} = \num{9.92203e-2} \quad \text{(via DTD)}
\]
\[
\dfrac{\mathrm{GTD}_1}{\mathrm{GTD}_2} = \num{9.92305e-2} \quad \text{(via Schwarzschild radius)}
\]
\[
\begin{aligned}
...
How do the two results compare? They are the same, confirming that the same compactness ratio $K$ is returned by both the Schwarzschild radius and the DeGerlia compactness ratio, and that both yield the same GTD result.
