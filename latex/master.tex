...
\begin{mdframed}
\textbf{Example (Static Mass):} System 1 is a same-mass reference at $\tfrac{4}{3}$ its Schwarzschild radius; System 2 is the system being measured, at $R_2 = \num{1.00000e8}$\,\unit{\meter}.
...
\smallskip\noindent\textbf{Calculate DTD for each System:}
  \begin{align*}
  \mathrm{DTD} &= \sqrt{K} \quad\text{where}\quad K = \dfrac{M}{R\,D_{\mathrm{crit}}}\\[2pt]
  \quad K_1 &= \dfrac{M_1}{R_1\,D_{\mathrm{crit}}} = \dfrac{r_s}{R_1} = \dfrac{r_s}{\tfrac{4}{3}\,r_s} = \dfrac{3}{4}\\
  \mathrm{DTD}_1 &= \sqrt{\tfrac{3}{4}} = \num{8.66025e-1}\\[2pt]
  \quad K_2 &= \dfrac{M_2}{R_2\,D_{\mathrm{crit}}} = \dfrac{r_s}{R_2} = \dfrac{\num{1485.23}}{\num{1.00000e8}} = \num{1.48523e-5}\\
  \mathrm{DTD}_2 &= \sqrt{\num{1.48523e-5}} = \num{3.85387e-3}\\[2pt]
...
\begin{align*}
K_1 &= \dfrac{r_{s1}}{R_1} &&= \dfrac{r_{s1}}{\tfrac{4}{3}\,r_{s1}} &&= \dfrac{3}{4}\\[2pt]
K_2 &= \dfrac{r_{s2}}{R_2} &&= \dfrac{\num{1485.23}}{\num{1.00000e8}} &&= \num{1.48523e-5}
\end{align*}

\noindent Calculate GTD via Schwarzschild radius ratio:
\begin{align*}
&\mathrm{GTD}_1 = \sqrt{1-K_1} = \sqrt{1-\tfrac{3}{4}} = \sqrt{\tfrac{1}{4}} = \num{5.00000e-1}\\[2pt]
...
&\mathrm{GTD}_1/\mathrm{GTD}_2 = \num{5.00004e-1} \quad \text{(via $D_{\mathrm{crit}}$)}
\end{align*}
\begin{align*}
&\text{difference} = 0 \quad \text{(both routes give the same value)}
\end{align*}

This pair is a hand-set illustration and is not among the cases tabulated in \ref{app:pair_table}.
\end{mdframed}
...
\smallskip\noindent\textbf{Calculate DTD for each System:}
 ...
 \smallskip\noindent\textbf{Calculate GTD ratio from DTD:}
  \nopagebreak
  \begin{align*}
  \dfrac{\mathrm{GTD}_1}{\mathrm{GTD}_2} &= \dfrac{\sqrt{1-\mathrm{DTD}_1^2}}{\sqrt{1-\mathrm{DTD}_2^2}} = \dfrac{\sqrt{1-(1)^2}}{\sqrt{1-(\num{2.05998e-3})^2}}\\
  &= \dfrac{\sqrt{1-1}}{\sqrt{1-\num{4.24352e-6}}} = \dfrac{\sqrt{0}}{\sqrt{\num{9.9999575648e-1}}}\\
...
\noindent Calculate $K$ values from the $r_s/R$ ratio:
\begin{align*}
K_1 &= \dfrac{r_{s1}}{R_1} &&= \dfrac{r_{s1}}{r_{s1}} &&= 1\\[2pt]
K_2 &= \dfrac{r_{s2}}{R_2} &&= \dfrac{\num{2.97046e3}\,\unit{\meter}}{\num{7.00000e8}\,\unit{\meter}} &&= \num{4.24352e-6}
\end{align*}

\noindent Calculate GTD via Schwarzschild radius ratio:
\begin{align*}
\mathrm{GTD}_1 &= \sqrt{1-K_1} = \sqrt{1-1} = \sqrt{0} = 0\\[2pt]
\mathrm{GTD}_2 &= \sqrt{1-K_2} = \sqrt{1-\num{4.24352e-6}}\\
  &= \sqrt{\num{9.9999575648e-1}}\\
  &= \num{9.9999787824e-1}\\[2pt]
...
\smallskip\noindent\textbf{Calculate DTD for each System:}
 ...
 \smallskip\noindent\textbf{Calculate GTD ratio from DTD:}
  \nopagebreak
  \begin{align*}
  \dfrac{\mathrm{GTD}_1}{\mathrm{GTD}_2} &= \dfrac{\sqrt{1-\mathrm{DTD}_1^2}}{\sqrt{1-\mathrm{DTD}_2^2}} = \dfrac{\sqrt{1-(\num{9.9506552e-1})^2}}{\sqrt{1-(\num{2.05998e-3})^2}}\\
  &= \dfrac{\sqrt{1-\num{9.9015539e-1}}}{\sqrt{1-\num{4.24352e-6}}}\\
  &= \dfrac{\sqrt{\num{9.84461e-3}}}{\sqrt{\num{9.999957565e-1}}}\\
  &= \dfrac{\num{9.92200e-2}}{\num{9.999978782e-1}} = \num{9.9220223e-2}
  \end{align*}
...
\smallskip\noindent\textbf{Time-dilation ratio between System 1 and System 2, computed two ways:}
\begin{align*}
\dfrac{\mathrm{GTD}_{S1}}{\mathrm{GTD}_{S2}} &= \num{9.92305e-2} \quad \text{(via $r_s$)}\\
\dfrac{\mathrm{GTD}_{D1}}{\mathrm{GTD}_{D2}} &= \num{9.92203e-2} \quad \text{(via $D_{\mathrm{crit}}$)}
\end{align*}
\begin{align*}
\text{difference} &= 0.000002\\
&\quad \text{(below the margin of error imparted by $G$,}\\
&\quad \text{$0.00015$, the gravitational constant's limit)}
\end{align*}
...
\smallskip\noindent\textbf{Calculate DTD for each System:}
  \begin{align*}
  \mathrm{DTD} &= \sqrt{K} \quad\text{where}\quad K = M/(R\,D_{\mathrm{crit}})\\[2pt]
...
\begin{mdframed}
\textbf{Example (Constant Density):}
...
\smallskip\noindent\textbf{Time-dilation ratio between System 1 and System 2, computed two ways:}
\begin{align*}
&\mathrm{GTD}_1/\mathrm{GTD}_2 = 1-\num{7.35193e-6} \quad \text{(via $r_s$)}\\
...
\begin{mdframed}
\textbf{Example (Constant Inertia):}
...
\smallskip\noindent\textbf{Time-dilation ratio between System 1 and System 2, computed two ways:}
\begin{align*}
&\mathrm{GTD}_1/\mathrm{GTD}_2 = 1-\num{7.44657e-3} \quad \text{(via $r_s$)}\\
...
\medskip
\noindent\textit{[Below: same case, auto-generated by \texttt{build\_example\_block.py} for comparison against the hand-written block above.]}
\medskip

\begin{mdframed}
\textbf{Example (General Case --- Generated):}
...
\smallskip\noindent\textbf{Calculate DTD for each System:}
 ...
 \smallskip\noindent\textbf{Calculate GTD ratio from DTD:}
  ...
  &= \dfrac{\sqrt{\num[group-digits=false]{9.9999999999999999999999999405907e-1}}}{\sqrt{\num[group-digits=false]{9.9999999999999999999999999851477e-1}}}\\
  &= \dfrac{\num[group-digits=false]{9.9999999999999999999999999702953e-1}}{\num[group-digits=false]{9.9999999999999999999999999257383e-1}}\\
  &= \num[group-digits=false]{9.9999999999999999999999999777215e-1}\\
  &= 1-\num{2.22785e-27}
  \end{align*}
...
\begin{align*}
\mathrm{GTD}_1 &= \sqrt{1-K_1} = \sqrt{1-\num{5.94093e-27}}\\
&= \sqrt{\num[group-digits=false]{9.9999999999999999999999999405907e-1}}\\
&= \num[group-digits=false]{9.9999999999999999999999999702954e-1}\\
&= 1-\num{2.97046e-27}\\[2pt]
\mathrm{GTD}_2 &= \sqrt{1-K_2} = \sqrt{1-\num{1.48523e-27}}\\
&= \sqrt{\num[group-digits=false]{9.9999999999999999999999999851477e-1}}\\
&= \num[group-digits=false]{9.99999999999999999999999999257384e-1}\\
&= 1-\num{7.42616e-28}\\[2pt]
...
\smallskip\noindent\textbf{Time-dilation ratio between System 1 and System 2, computed two ways:}
\begin{align*}
&\mathrm{GTD}_1/\mathrm{GTD}_2 = 1-\num{2.22785e-27} \quad \text{(via $r_s$)}\\
...
This case is tabulated in Table~\ref{tab:pair_ratios}, column Classical of \ref{app:pair_table}.
\end{mdframed}
