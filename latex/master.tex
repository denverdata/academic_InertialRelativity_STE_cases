...
\begin{mdframed}
\textbf{Example (Static Mass, benchmark):} System 1 is the system being measured; System 2 is a same-mass reference at its Schwarzschild radius. The benchmark configuration sets $D_{norm,2} = 1$, the condition under which the two-system compactness ratio reduces to the standard one-system Schwarzschild GTD expression.
...
\[
\mathrm{GTD}_{s,1}/\mathrm{GTD}_{s,2} = \frac{1 - 9.00777 \times 10^{-1}}{1 - 2.12176 \times 10^{-6}} = 1 - 9.00776 \times 10^{-1}
\]
\[
\mathrm{GTD}_{d,1}/\mathrm{GTD}_{d,2} = \frac{1 - 9.00780 \times 10^{-1}}{1 - 2.12176 \times 10^{-6}} = 1 - 9.00780 \times 10^{-1}
\]
