...
LABELS = {
    ...
    'D_1 (kg/m)':     r'$D_1$ (kg/m)',
    'D_2 (kg/m)':     r'$D_2$ (kg/m)',
    'D_1_norm':       r'$D_{\mathrm{norm},1}$',
    'D_2_norm':       r'$D_{\mathrm{norm},2}$',
    'r_s_1 (m)':      r'$r_{\mathrm{s}1}$ (m)',
    'r_s_2 (m)':      r'$r_{\mathrm{s}2}$ (m)',
    'gtd_1':          r'$\mathrm{GTD}_{\mathrm{s}1}$',
    'gtd_2':          r'$\mathrm{GTD}_{\mathrm{s}2}$',
    'GTD_s_1':        r'$\mathrm{GTD}_{\mathrm{s}1}$',
    'GTD_s_2':        r'$\mathrm{GTD}_{\mathrm{s}2}$',
    'dtd_1':          r'$\mathrm{DTD}_1$',
    'dtd_2':          r'$\mathrm{DTD}_2$',
    ...
    'k_s':                                  r'$k_{\mathrm{s}}$',
    'k_d':                                  r'$k_{\mathrm{d}}$',
    'GTD_d_1':                              r'$\mathrm{GTD}_{\mathrm{d}1}$',
    'GTD_d_2':                              r'$\mathrm{GTD}_{\mathrm{d}2}$',
    'I_1/I_2':                              r'$I_1/I_2$',
    'I_2/I_1':                              r'$I_2/I_1$',
