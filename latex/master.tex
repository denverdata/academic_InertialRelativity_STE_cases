...
k = \frac{M_1 \overline{R}_2}{M_2 \overline{R}_1} = \frac{\overline{R}_2}{\overline{R}_1}
\]
Note, this is the gravitational time dilation formula, where we are comparing with $r_{\mathrm{s}}$. Because there is no valid value for $\mathrm{GTD}$ exactly at $r_{\mathrm{s}}$, we set the comparison radius to $1.00001\,r_{\mathrm{s}}$, a negligible amount above $r_{\mathrm{s}}$.
