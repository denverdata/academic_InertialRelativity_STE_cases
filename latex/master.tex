...
\twocolumn[
  ...
  \normalsize\text{DOI: \href{https://doi.org}{}}
...
\vspace{0.3cm} & \vspace{0.3cm} \\
 ...
 & \noindent\small{Originally published: July 4, 2026 C.E. Celebrating the Quarter-millennial Anniversary of the Independence of the United States of America} \\
 & \noindent\small{Revision 2.0 July 5, 2026 C.E.} \\
 & \noindent\small{OPEN RESEARCH PREPRINT - FOR PEER REVIEW} \\
\includegraphics{head_foot/dates} & \\
 & \vspace{0.3cm} \\
 & \noindent\normalsize{ABSTRACT: In this paper, we show that the time dilation between two systems is defined solely by their relative DeGerlia Inertial Density $D$, defined as mass divided by mean radius about a selected axis. We demonstrate this in the gravitational case by calculating $D$ of an example system relative to a system of the same mass at its Schwarzschild radius, recovering the exact result calculated using the Schwarzschild gravitational time-dilation (GTD) equation. To carry out this demonstration, we introduce the DeGerlia Time Dilation Framework, a simple, mathematically equivalent framework fully defined by general relativity.} \\
 & \vspace{0.15cm} \\
