...
d\tau/dt = \sqrt{1-k}
\end{equation}
where $k = r_{s}/R = 2GM/(Rc^2)$, $G$ is the gravitational constant\cite{codata2018}, $M$ the system's mass, $R$ its radius, $r_{s} = 2GM/c^2$ its Schwarzschild radius, and $c$ the speed of light, with $c = \num{2.99792458e8}\,\unit{\meter\per\second}$ and $G = (\num{6.67430e-11} \pm \num{1.5e-15})\,\unit{\meter\cubed\per\kilogram\per\second\squared}$.
