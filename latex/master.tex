...
\medskip\noindent\textbf{Calculate DTD for each System:}
  \[
  \begin{aligned}
  \mathrm{DTD} &= \sqrt{K}, \quad K =
  (M/R)/D_{\mathrm{crit}}\\[2pt]
  \text{System 1:}\quad K &= (2.00000 \times
  10^{30}\,\text{kg}/3.00000 \times 10^{3}\,\text{m}) / 6.73295
  \times 10^{26}\,\text{kg/m}\\
  &= 9.9015538 \times 10^{-1}\\
  \mathrm{DTD}_1 &= \sqrt{9.9015538 \times 10^{-1}} = 9.9506552
  \times 10^{-1}\\[2pt]
  \text{System 2:}\quad K &= (2.00000 \times
  10^{30}\,\text{kg}/7.00000 \times 10^{8}\,\text{m}) / 6.73295
  \times 10^{26}\,\text{kg/m}\\
  &= 4.24352 \times 10^{-6}\\
  \mathrm{DTD}_2 &= \sqrt{4.24352 \times 10^{-6}} = 2.05998
  \times 10^{-3}\\[2pt]
  \mathrm{DTD}_1/\mathrm{DTD}_2 &= 9.9506552 \times 10^{-1} /
  2.05998 \times 10^{-3} = 4.83046 \times 10^{2}
  \end{aligned}
  \]
 ...
 \medskip\noindent\textbf{Calculate GTD ratio from DTD:}
  ...
  &= \sqrt{1-\mathrm{DTD}_1^2}/\sqrt{1-\mathrm{DTD}_2^2}\\
  &= \sqrt{1-(9.9506552 \times 10^{-1})^2}/\sqrt{1-(2.05998
  \times 10^{-3})^2}\\
  &= \sqrt{1-9.9015539 \times 10^{-1}}/\sqrt{1-4.24352 \times
  10^{-6}}\\
  &= \sqrt{9.84461 \times 10^{-3}}/\sqrt{9.999957565 \times
  10^{-1}}\\
  &= 9.92200 \times 10^{-2}/(9.999978782 \times 10^{-1})\\
  &= 9.9220223 \times 10^{-2}
  \end{aligned}
  \]
